...
def run_one_worker(task_id, physical_devices, seed):
    ...
    local_devices = tuple(range(len(physical_devices)))
...
def print_summary(results, parallel_wall_us):
    print("=" * 110)
    print("WP3-D BSGS block-parallel 1worker×1GPU probe")
    print("=" * 110)
...
def main():
    ...
    out = {
        "experiment": "wp3d_bsgs_block_parallel_1worker_1gpu_probe",
    ...
    out_path = out_dir / "wp3d_bsgs_block_parallel_1worker_1gpu_probe_report.json"
