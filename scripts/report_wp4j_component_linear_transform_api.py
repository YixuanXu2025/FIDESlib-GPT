...
def main():
    ...
    report = {
        "experiment": "wp4j_component_linear_transform_api",
    ...
    print("=" * 100)
    print("WP4-J component linear transform API report")
    print(json.dumps(report, ensure_ascii=False, indent=2))

    out_dir = Path("/workspace/FIDESlib-GPT/reports")
    out_dir.mkdir(parents=True, exist_ok=True)
    out_path = out_dir / "wp4j_component_linear_transform_api_report.json"
