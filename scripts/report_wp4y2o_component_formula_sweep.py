...
def make_line5_rows(rt, zero_rows, T00_cmt_rows, n, line5_variant):
    ...
    for i in range(n):
        ...
        # Internal line5 add remains add_coeff_ct, as in current probe.
        line5_rows.append(rt.add_coeff_ct(ks_output, lin_term))
...
def main():
    ...
    report = {
        "experiment": "wp4y2o_component_formula_sweep",
        "purpose": (
    ...
    out_path = out_dir / "wp4y2o_component_formula_sweep_report.json"
    ...
    print("=" * 100)
    print("WP4-Y2o component formula sweep")
